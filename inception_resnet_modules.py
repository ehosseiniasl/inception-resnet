...
def stem_v4(x):
    ...
    '''
    h1 = Convolution2D(32, 3, 3, border_mode='same', subsample=(2, 2))(x) # x shape = (1, h, w)
    h2 = Convolution2D(64, 3, 3)(h1)
    h3_max_pool = MaxPooling2D(pool_shape=(3, 3), strides=(2, 2))(h2)
    h3_conv = Convolution2D(96, 3, 3, subsample=(2, 2))(h2)
    ...
    h10_1 = Convolution2D(192, 3, 3, border_mode='same', subsample=(2, 2))(h9)
...
def stem_resnet(x):
    ...
    output = Convolution2D(256, 3, 3, border_mode='same', subsample=(2, 2))(h6)
    return output
...
def reduction_A(x, k, l, m, n):
    ...
    h3_1 = Convolution2D(m, 3, 3, subsample=(2, 2), border_mode='same')(h2_1)
    h1_2 = Convolution2D(n, 3, 3, subsample=(2, 2), border_mode='same')(x)
...
def reduction_B(x):
    ...
    h4_1 = Convolution2D(320, 3, 3, subsample=(2, 2), border_mode='same')(h3_1)
    h1_2 = Convolution2D(192, 1, 1, border_mode='same')(x)
    h2_2 = Convolution2D(192, 3, 3, subsample=(2, 2), border_mode='same')(h1_2)
    h1_3 = MaxPooling2D(pool_size=(3, 3), strides=(2, 2))(x)
...
def reduction_resnet_B(x):
    ...
    h3_1 = Convolution2D(256, 3, 3, subsample=(2, 2), border_mode='same')(h2_1)
    h1_2 = Convolution2D(256, 1, 1, border_mode='same')(x)
    h2_2 = Convolution2D(256, 3, 3, subsample=(2, 2), border_mode='same')(h1_2)
    h1_3 = Convolution2D(256, 1, 1, border_mode='same')(x)
    h2_3 = Convolution2D(384, 3, 3, subsample=(2, 2), border_mode='same')(h1_3)
